 ...
 * @author ander
 */
public class ListItemTemaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/ListItemTema.jsp").forward(request, response);
    }
    ...
    public String getServletInfo() {
        return "Listagem de itens de tema";
    }// </editor-fold>
